...
import { EmployerProfileViewRecord, EmployerProfileEditRecord } from "./state/profileRecordType";
...
const EmployerProfileScreen = () => {
    ...
    const validateForm = () => {
        let anyError = false
        EmployerProfileEditRecord.fields.forEach((field) => {
            ...
            <View style={{ flex: 1, backgroundColor: "#fff" }}>
                ...
                <ScrollView keyboardShouldPersistTaps="handled">
                    ...
                    <KeyboardAvoidingView enabled>
                        {EmployerProfileViewRecord.fields.map((field) =>
        ...
        return (
            <View style={{ flex: 1, backgroundColor: "#fff" }}>
                ...
                <ScrollView keyboardShouldPersistTaps="handled">
                    ...
                    <KeyboardAvoidingView enabled>
                        {EmployerProfileEditRecord.fields.map((field) =>
